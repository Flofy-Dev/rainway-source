...
<body>
    <x-forumapp>
    <nav class="v-navbar navbar navbar-expand-md navbar-light bg-white shadow py-3">
        <div class="container">
            <a class="navbar-brand font-semibold text-xl text-gray-800 leading-tight" href="{{ url(config('forum.web.router.prefix')) }}">{{ config('app.name'); }} Forum</a>
            ...
            <div class="collapse navbar-collapse" :class="{ show: !isCollapsed }">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url(config('forum.web.router.prefix')) }}">Homepage</a>
                    </li>
                    <li class="nav-item">
